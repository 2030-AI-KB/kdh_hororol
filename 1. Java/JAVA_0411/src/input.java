...
public class input {
	...
	public static void main(String[] args) {
		...
		// 초기화 :: [타입] [변수이름(name)] = [저장할 값];
			...
			// (ex) int num =3;	"int형의 정보를 담을 수 있고, 이름이 num인 변수를 생성함과 동시에 num이라는 변수에 3이라는 값을 저장하라."
