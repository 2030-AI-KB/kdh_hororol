...
public class Class { // 대표 클래스
	...
	public static void main(String[] args) {
		...
		java.setName("java");  // setName :: java.name = name(매개변수로 받는 정보);
		java.writer ="Kim";
		java.publish ="한빛아카데미";
		java.year = 2005;
		...
		System.out.println("책 이름: " + sql.getName());
